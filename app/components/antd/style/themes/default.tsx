const brandPrimary = '#284e98';
const brandPrimaryTap = '#70E07C';
...
export default {
  ...
  color_text_placeholder: '#D0D0D0',           // 文本框提示
  color_text_disabled: '#c0c0c0',              // 失效
  color_text_caption: '#999999',               // 辅助描述
  ...
  brand_success: '#284e98',
  brand_warning: '#FBB325',
  brand_error: '#FF4D4D',
  brand_important: '#FF4D4D',  // 用于小红点
  brand_wait: '#284e98',
  ...
  warning_button_fill: '#FF4D4D',
  warning_button_fill_tap: '#FF7070',
