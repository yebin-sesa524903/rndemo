...
const ImageItem = ({
  ...
  const isErrorImage = () => {
    if(imageDimensions && (imageDimensions.width === 0 || imageDimensions.height === 0)) return true;
    return false;
  }
  ...
  return (
    <View>
      ...
      >
        {(((loadingError || isErrorImage()) && ErrorComponent) && <ImageErrorWrapper ErrorComponent={ErrorComponent} />)}
