...
import {
  TICKET_MESSAGEINFO_CHANGED,
  TICKET_MESSAGE_CLEAN,
  TICKET_MESSAGE_SAVE_REQUEST, TICKET_MESSAGE_SAVE_SUCCESS, TICKET_MESSAGE_SAVE_FAILURE,
...
export default function(state=defaultState,action){
  ...
  switch (action.type) {
    case TICKET_MESSAGEINFO_CHANGED:
      return infoChanged(state,action);
    case TICKET_MESSAGE_SAVE_REQUEST:
